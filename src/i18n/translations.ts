...
export const translations = {
  en: {
    ...
    hoit: {
      heroAccent: "Hands On",
      heroRest: "Integrative Therapy",
      heroLead: "Athletic therapy and massage therapy services for all ages.",
      ...
      pricing: [
        { id: "consult", name: "AT / Massage Consult", price: "$150 + tax", note: "New clients only" },
      ...
      aboutTitle: "About Me",
      aboutBody:
        "Paste your about me here. A short intro on your background, certifications, approach, and what clients can expect.",
      ...
      privacyP3: "This page is informational and not legal advice.",
      ...
      cancellationP2: "To cancel, please use our contact form.",
    ...
    recovr: {
      heroAccent: "RECOVR",
      heroRest: "Sports",
      heroLead: "High performance training and recovery for athletes and active people.",
  ...
  fr: {
    ...
    hoit: {
      heroAccent: "Hands On",
      heroRest: "Integrative Therapy",
      heroLead: "Services de thérapie sportive et de massothérapie pour tous les âges.",
      heroPrimaryCta: "Voir les services",
      heroSecondaryCta: "Réserver une séance",
      ...
      aboutBody:
        "Ajoutez ici votre texte de présentation : votre parcours, vos certifications, votre approche et ce que les clients peuvent attendre.",

      privacyTitle: "Politique de confidentialité",
      privacyP1:
        "Nous ne recueillons que les informations nécessaires pour réserver et offrir les services, comme votre nom, vos coordonnées et l'historique de santé que vous choisissez de partager.",
      privacyP2:
        "Nous conservons les dossiers de façon sécuritaire et ne vendons pas vos données. Vous pouvez demander une copie ou une correction de vos informations en tout temps en utilisant notre formulaire de contact.",
      privacyP3: "Cette page est fournie à titre informatif et ne constitue pas un avis juridique.",

      cancellationTitle: "Politique d'annulation",
      cancellationP1:
        "Veuillez donner un préavis d'au moins 24 heures pour annuler ou modifier un rendez-vous. Les annulations tardives ou absences peuvent entraîner des frais allant jusqu'au tarif complet.",
      cancellationP2: "Pour annuler, veuillez utiliser notre formulaire de contact.",
    ...
    recovr: {
      ...
      heroPrimaryCta: "Explorer les programmes",
      heroSecondaryCta: "Contact",
