...
export function Hero() {
  return (
    <section className="relative overflow-hidden pt-28 pb-24 bg-[#020617]">
      ...
      {/* Glow blobs */}
      <div
        className="pointer-events-none absolute -left-40 -bottom-40 h-80 w-80 rounded-full bg-[#22A1FF]/18 blur-3xl"
        aria-hidden="true"
      />
      <div
        className="pointer-events-none absolute -right-40 -top-40 h-80 w-80 rounded-full bg-[#22A1FF]/30 blur-3xl"
        aria-hidden="true"
      />
      ...
      <div className="relative container section max-w-5xl">
        ...
        <div className="rounded-3xl bg-black/85 border border-[#22A1FF]/40 backdrop-blur-xl p-8 md:p-10 shadow-[0_40px_140px_rgba(34,161,255,0.9)]">
          ...
          <div className="mt-8 flex flex-wrap gap-4">
            <a
              href="#services"
              className="inline-flex items-center justify-center rounded-full px-6 md:px-8 py-3 text-sm md:text-base font-semibold bg-[#020617] text-white border border-white/20 shadow-[0_18px_60px_rgba(15,23,42,0.9)] hover:bg-black hover:-translate-y-[1px] transition-transform duration-200"
            >
              View Services
            </a>
            <a
