        ...
        <div className="grid sm:grid-cols-3 gap-6">
          {plans.map((p) => (
            <div key={p.name} className="card card-accent-lavender p-6">
              ...
              <a href="mailto:handsonintegrativetherapy@gmail.com" className="btn btn-lavender mt-6">Book session</a>
            </div>
          ))}
        </div>
      </div>
    ...
    <section id="privacy" className="section bg-black">
      <div className="container">
        ...
        <div className="glass p-6 text-gray-700 space-y-3">
          ...
          <p>We keep records securely and do not sell personal data. You may request a copy or correction of your information at any time by emailing <a className="text-hoit-purple" href="mailto:handsonintegrativetherapy@gmail.com">handsonintegrativetherapy@gmail.com</a>.</p>
    ...
    <section id="cancellation" className="section bg-black">
      <div className="container">
        ...
        <div className="glass p-6 text-gray-700 space-y-3">
          ...
          <p>To cancel, email <a className="text-hoit-purple" href="mailto:handsonintegrativetherapy@gmail.com">handsonintegrativetherapy@gmail.com</a>.</p>
        </div>
      </div>
    </section>
  );
    ...
    <section id="contact" className="section bg-black">
      <div className="container">
        <div className="card card-accent-lavender p-6">
          ...
          <a className="text-hoit-purple hover:underline" href="mailto:handsonintegrativetherapy@gmail.com">
